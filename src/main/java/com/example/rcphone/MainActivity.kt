...
import com.example.rcphone.ringout.CallRingOutPublic
import com.example.rcphone.ringout.Call_RingOut
...
class MainActivity : AppCompatActivity() {
    ...
    class Test(phone: String,context: Context) : AsyncTask<Void, Void, Unit>() {
        ...
        override fun doInBackground(vararg p0: Void?) {
            ...
            var callRingout = CallRingOutPublic(phoneNumber,mContext)
